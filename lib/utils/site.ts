export const SITE = {
  ...
  description:
    "Affordable electric scooters from Xypro, Jett & 4ALL. 50+ Mobility Centers, 24-hour service, component-level warranty. No licence required. Book a free test ride today.",
